...
HerkulexServo::HerkulexServo(const std::string& _name, const RegisterMapper& _mapper, unsigned char _hw_id,
                             bool _reverse, unsigned int _offset, double _scale)
    : name(_name), hw_id(_hw_id), reverse(_reverse), offset(_offset), scale(_scale), register_mapper(_mapper)
{
}
