...
{
	const short temperature_conversion_table[] = {-7947,-7178,-6320,-5781,-5380,-5058,-4786,-4549,-4340,-4151,-3979,-3820,-3673,-3535,
	...
	if (raw >= sizeof(temperature_conversion_table)/sizeof(temperature_conversion_table[0])) return std::nan("");
